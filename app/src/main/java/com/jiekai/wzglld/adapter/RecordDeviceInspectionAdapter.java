...
public class RecordDeviceInspectionAdapter extends MyBaseAdapter {

    public RecordDeviceInspectionAdapter(Context context, List dataList) {
    ...
    public View buildData(int position, View cellView, BusinessHolder viewHolder) {
        ...
        DeviceinspectionEntity item = (DeviceinspectionEntity) dataList.get(position);
