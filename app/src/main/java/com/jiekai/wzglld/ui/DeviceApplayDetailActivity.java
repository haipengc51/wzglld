...
public class DeviceApplayDetailActivity extends MyBaseActivity implements View.OnClickListener {
    ...
    public void initData() {
        ...
        currentData = (DeviceapplyEntity) getIntent().getSerializableExtra(IntentFlag.DATA);
    }

    @Override
    public void initOperation() {
        if (currentData != null) {
            duihao.setText(CommonUtils.getDataIfNull(currentData.getSYDH()));
            jinghao.setText(CommonUtils.getDataIfNull(currentData.getSYJH()));
            operatorPeople.setText(CommonUtils.getDataIfNull(currentData.getCzrname()));
            operatorTime.setText(TimeUtils.dateToStringYYYYmmdd(currentData.getSQSJ()));
            operatorRemark.setText(CommonUtils.getDataIfNull(currentData.getSQBZ()));
            ...
            showCommitImage(currentData.getSQID());
            getSHRName();
        } else {
                ...
                .execut(mContext, new DbCallBack() {
                    ...
                    public void onResponse(List result) {
                        if (result != null && result.size() != 0) {
                            ...
                            GlidUtils.displayImage(mActivity, Config.WEB_HOLDE + entity.getWJDZ(), applyImage);
                        }
                    }
                });
    }
