...
public class RecordDeviceInDetailActivity extends MyBaseActivity implements View.OnClickListener {
    @BindView(R.id.back)
    ImageView back;
    @BindView(R.id.title)
    TextView title;
    ...
    public void initView() {
        setContentView(R.layout.activity_record_device_in_detail);
    }
