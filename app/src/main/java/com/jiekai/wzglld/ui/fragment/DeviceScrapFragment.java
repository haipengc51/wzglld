...
public class DeviceScrapFragment extends MyNFCBaseFragment implements View.OnClickListener {
    @BindView(R.id.back)
    ImageView back;
    @BindView(R.id.title)
    TextView title;
    ...
    public View initView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.activity_device_scrap, container, false);
    }
...
//                finish();
    ...
    private void uploadImage() {
        ...
        romoteImageName = mActivity.userData.getUSERID() + currentDevice.getBH().toString() + System.currentTimeMillis() + imageType;
    ...
    private void insertScrap() {
        DBManager.dbDeal(DBManager.EVENT_INSERT)
                ...
                .params(new Object[]{currentDevice.getBH(),
                        new java.sql.Date(new java.util.Date().getTime()), mActivity.userData.getUSERID()})
                .execut(new DbCallBack() {
                    @Override
                    public void onDbStart() {
                    }
